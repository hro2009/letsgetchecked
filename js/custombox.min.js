!function (t, e) {
    ...
    var o, a, l, h, c, u, f, d, _, g, p, m, v, E, T, y, C, I, A, b, D, S, w, N, O, k, P = function (t) {
        ...
        R = (m = "button", E = "." + (v = "bs.button"), T = ".data-api", y = (p = e).fn[m], C = "active", I = "btn", A = "focus", b = '[data-toggle^="button"]', D = '[data-toggle="buttons"]', S = "input", w = ".active", N = ".btn", O = {
                        ...
                        if (!this._element.disabled && !t(this._element).hasClass(u)) {
                            ...
                            if (a._clearMenus(), !i) {
                                ...
                                if (t(e).trigger(r), !r.isDefaultPrevented()) {
                                    if (!this._inNavbar) {
                                        if ("undefined" == typeof n) throw new TypeError("Dropdown require Popper.js (https://popper.js.org)");
                                        var o = this._element;
            ...
            var e = "tooltip", i = "bs.tooltip", o = "." + i, a = t.fn[e], l = new RegExp("(^|\\s)bs-tooltip\\S+", "g"),
                ...
                C = "manual", I = function () {
                    function a(t, e) {
                        if ("undefined" == typeof n) throw new TypeError("Tooltips require Popper.js (https://popper.js.org)");
    ...
    !function (t) {
        if ("undefined" == typeof t) throw new TypeError("JavaScript requires jQuery. jQuery must be included before  JavaScript.");
        var e = t.fn.jquery.split(" ")[0].split(".");
        if (e[0] < 2 && e[1] < 9 || 1 === e[0] && 9 === e[1] && e[2] < 1 || e[0] >= 4) throw new Error("JavaScript requires at least jQuery v1.9.1 but less than v4.0.0")
